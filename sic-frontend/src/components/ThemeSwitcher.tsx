...
function ThemeSwitcher() {
  ...
  return (
    <Button
      onClick={toggleDark}
      className="text-gray-500 ring-4 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
    >
      <svg
